...
{
    public partial class PfrmVentaNueva : Form
    {

        private PV.FrmVenta _p;
        ...
        public PfrmVentaNueva(FrmVenta p,string idVenta = "0")
        {
            InitializeComponent();
            try
            {
        ...
        private void btnBuscarVehiculo_Click(object sender, EventArgs e)
        {
            try
            {
                _FrmSeleccionAuto frmSAuto = new _FrmSeleccionAuto(this);
